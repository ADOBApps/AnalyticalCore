...
/*$("#s-kps-but1-e2").click(function(){
	var counter = parseInt($("#s-kps-subind-element2").val());
	counter++;
	$("#s-kps-subind-element2").val(counter.toString());
});
$("#s-kps-but2-e2").click(function(){
	var counter = parseInt($("#s-kps-subind-element2").val());
	if (counter<=1) {
		$("#s-kps-subind-element2").val("1");
	} else {
...
$("#s-kps-btn_close").click(function(){
	$("#s-kps-virtkey").hide();
});
$("#s-kps-btn_inp-exp").click(function(){
	var last_value = $("#" + s_kps_instance).val();
	$("#" + s_kps_instance).val(last_value + "^{}");
});
$("#s-kps-btn_inp-sub").click(function(){
	var last_value = $("#" + s_kps_instance).val();
	$("#" + s_kps_instance).val(last_value + "_{}");
});
$("#s-kps-btn_inp-10x").click(function(){
	var last_value = $("#" + s_kps_instance).val();
	$("#" + s_kps_instance).val(last_value + "*10^{}");
});
...
$(document).on("submit", "#s-kps-form", function(e){
